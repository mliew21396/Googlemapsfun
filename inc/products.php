...
function get_products_search($s) {
    ...
    try {
        ...
        echo "Data cuould not be retrieved from the datebase.";
        exit;
    }
...
*returns a boolean flase if no product matches the sku
*@param     int     $sku    the sku
*@returns   mixed  array    list or product information for the one matching product
